...
export default function ProductLayout({ children }: { children: ReactNode }) {
  return (
    <Fragment>
      <Show when={!!localStorage.getItem("apiKey")}>
        {children}
      </Show>
      <Show when={!localStorage.getItem("apiKey")}>
        <div className="box">
          <p className="branding">Hold On</p>
          <p className="muted-text">Seems like you don't have an active subscription in this workspace to use/view this Product</p>

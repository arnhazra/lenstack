enum Constants {
    ...
    HomeIntro1 = `Envision and create intelligent apps with the latest`,
    HomeIntro2 = `technologies announced at Lenstack.`,
    HomeIntro3 = `Start with 1 month free trial, upgrade on demand.`,
    HomeIntro4 = `Build in our new platform.`,

...
const endPoints = {
    ...
    togglePaymentStatusOnEndpoint: `${apiHost}/api/transaction/togglepaymentstatuson`,
    togglePaymentStatusOffEndpoint: `${apiHost}/api/transaction/togglepaymentstatusoff`,

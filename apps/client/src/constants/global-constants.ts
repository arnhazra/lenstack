export const uiConstants = {
  brandName: "ArcStack",
  homeHeader1: "Develop, Ship & Scale",
  homeHeader2: "Powered by",
  homeHeader3: "Built on Polygon Chain",
  homeIntro1: "Start with a hobby plan, for free. Upgrade on demand",
  homeIntro2: "Starting at 1.09 MATIC / month",
  connectionErrorMessage: "Connection Error",
  identityVerificationMessage: "Verifying Identity",
  errorMessage: "404, Lost",
  noNetworkMessage: "No Network",
  toastSuccess: "Done",

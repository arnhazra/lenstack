...
export default function Page({ params }: { params: { tab: string } }) {
    ...
    return (
      <div
        ...
        className={`cursor-pointer flex capitalize ${
          tab === selectedTab ? "" : "text-zinc-500"
        }`}
        onClick={(): void => router.push(`/settings/${tab}`)}
      >
  ...
  return (
    <Suspense
      condition={tabsList.includes(selectedTab as Tabs)}
        ...
        <Suspense condition={!pricing.error} fallback={<ErrorComponent />}>
          <div className="mx-auto grid w-full gap-2">
            <div className="flex justify-between">
              ...
              <Suspense
                condition={selectedTab === Tabs.Organization}
                fallback={null}
              >
                <Button
                  size="icon"
          ...
          <div className="mx-auto grid w-full items-start gap-4 md:grid-cols-[180px_1fr] lg:grid-cols-[250px_1fr]">
            ...
            <div>
              ...
              <Suspense
                ...
                fallback={null}
              >
                <section className="grid gap-2">{renderOrgs}</section>
              </Suspense>
              <Suspense
                condition={selectedTab === Tabs.Sustainability}
                fallback={null}
              >
                <SectionPanel

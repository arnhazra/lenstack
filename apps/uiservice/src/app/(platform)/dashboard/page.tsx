      ...
      <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
          <Card className="sm:col-span-2">
            ...
            <CardFooter>
              <Button onClick={(): void => router.push("/settings/workspace")}>
                View Workspaces
              </Button>
            </CardFooter>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardDescription className="text-lg">XP Credits</CardDescription>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-xs text-muted-foreground">Selected Tier</div>
            </CardContent>
            <CardFooter></CardFooter>
          </Card>
        </div>
